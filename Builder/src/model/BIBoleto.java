...
public class BIBoleto implements Boleto {
	...
	public BIBoleto (String sacado , String cedente , double valor , Calendar vencimento , int nossoNumero) {
	...
	public String toString () {
		...
		stringBuilder.append("Boleto Banco Itaú");
